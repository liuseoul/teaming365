  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden bg-gray-50">
        ...
        {/* Header */}
        <div className="flex items-center px-6 py-4 bg-indigo-50 border-b border-indigo-200 flex-shrink-0">
          <h1 className="text-lg font-semibold text-gray-900">My Work Statistics</h1>
